...
`}),e(c,{height:200,children:e(g,{theme:{bgCell:"#F2F9FF"},getCellContent:t,columns:w,rows:n.length})}),e(h,{children:"### Column themes\nThemes can be applied at the column level as well by setting the `themeOverride` on the `GridColumn`."}),e(s,{children:`
...
`}),e(c,{height:200,children:e(g,{theme:{bgCell:"#F2F9FF"},getCellContent:t,columns:m,rows:n.length})}),e(h,{children:"### Row themes"}),e(s,{children:`
...
`}),e(c,{height:200,children:e(g,{theme:{bgCell:"#F2F9FF"},getRowThemeOverride:u,getCellContent:t,columns:m,rows:n.length})}),e(h,{children:"### Cell themes"}),e(s,{children:`
...
`}),e(c,{height:200,children:e(g,{theme:{bgCell:"#F2F9FF"},getRowThemeOverride:u,getCellContent:T,columns:m,rows:n.length})})]})};a.storyName="08. Theming";var f,y,C;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`() => {
  const getContent = React.useCallback((cell: Item): GridCell => {
    const [col, row] = cell;
