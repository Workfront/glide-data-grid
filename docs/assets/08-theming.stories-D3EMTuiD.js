...
`),e.createElement(s,{height:200},e.createElement(d,{theme:{bgCell:"#F2F9FF"},getCellContent:t,columns:T,rows:n.length})),e.createElement(g,null,"### Column themes\nThemes can be applied at the column level as well by setting the `themeOverride` on the `GridColumn`."),e.createElement(h,null,`
...
`),e.createElement(s,{height:200},e.createElement(d,{theme:{bgCell:"#F2F9FF"},getCellContent:t,columns:c,rows:n.length})),e.createElement(g,null,"### Row themes"),e.createElement(h,null,`
...
`),e.createElement(s,{height:200},e.createElement(d,{theme:{bgCell:"#F2F9FF"},getRowThemeOverride:m,getCellContent:t,columns:c,rows:n.length})),e.createElement(g,null,"### Cell themes"),e.createElement(h,null,`
...
`),e.createElement(s,{height:200},e.createElement(d,{theme:{bgCell:"#F2F9FF"},getRowThemeOverride:m,getCellContent:C,columns:c,rows:n.length})))};l.storyName="08. Theming";var p,f,y;l.parameters={...l.parameters,docs:{...(p=l.parameters)==null?void 0:p.docs,source:{originalSource:`() => {
  const getContent = React.useCallback((cell: Item): GridCell => {
    const [col, row] = cell;
