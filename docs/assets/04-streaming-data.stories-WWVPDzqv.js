...
The Grid does not care of the data is coming down over the wire or being generated locally. Informing the grid of changes to the data is done by calling the \`updateCells\` function on a bound ref.`}),n(h,{children:`
const ref = React.useRef<DataEditorRef | null>(null);

return <DataEditor {...rest} ref={ref} />
`}),n(s,{children:`
Data can now be updated by calling mutating the backing store and using the ref to update cells.`}),n(h,{children:`
const onButtonClick = () => {
...
`}),n("button",{onClick:M,children:"Swappy Swappy"}),n(R,{height:400,children:n(g,{ref:p,getCellContent:k,columns:u,rows:o.current.length})}),n(s,{children:`
## Showing updates
        
If \`getContent\` is updated to also return the last time a cell was updated the data grid will highlight cells as they update.`}),n(h,{children:`
...
}`,...(C=(f=d.parameters)==null?void 0:f.docs)==null?void 0:C.source}}};const F=["StreamingData"];export{d as StreamingData,F as __namedExportsOrder,X as default};
